			...
			case BarFight:
			{
				...
				for (auto peon : Peons)
				{
					if (peon->GetGUIDLow() == 265060)
						peon->GetMotionMaster()->MovePoint(0, -1044.2826f, -3652.5847f, 23.8791f, true);
					else if (peon->GetGUIDLow() == 265059)
						peon->GetMotionMaster()->MovePoint(0, -1048.0774f, -3643.3633f, 23.8791f, true);
				}
				...
				for (auto hand : DeckHands)
				{
					...
					{
						hand->GetMotionMaster()->MovePoint(0, -1048.6938f, -3654.7166f, 23.8777f, true);
						hand->AI()->DoAction(SetHostileFaction);
					}
					else if (hand->GetGUIDLow() == 265488)
					{
						hand->GetMotionMaster()->MovePoint(0, -1049.5637f, -3642.4080f, 23.8778f, true);
						hand->AI()->DoAction(SetHostileFaction);
					}
				}
				break;
