...
extern int main(int argc, char **argv)
{
    ...
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "  _   _                  _              _                                     ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " | | | |   __ _   _ __  | |__    _ __  (_)  _ __     __ _    ___   _ __   ___ ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " | |_| |  / _` | | '__| | '_ \\  | '__| | | | '_ \\   / _` |  / _ \\ | '__| / __|");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " |  _  | | (_| | | |    | |_) | | |    | | | | | | | (_| | |  __/ | |    \\__ \\ ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " |_| |_|  \\__,_| |_|    |_.__/  |_|    |_| |_| |_|  \\__, |  \\___| |_|    |___/");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "                                                    |___/                     ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "                                                                   Authserver    ");
